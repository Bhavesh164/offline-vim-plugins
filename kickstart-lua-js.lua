...
-- require("luasnip.loaders.from_snipmate").load({ include = { "php","javascript", "javascriptreact", "typescriptreact" } }) --for snippets to work need to install vim-snippets plugin
-- nvim-cmp setup
